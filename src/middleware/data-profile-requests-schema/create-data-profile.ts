...
export const dataProfileCreateBodySchema = Joi.object({
  profile_name: Joi.string().required().regex(disallowedCharsRegexWithoutSpace, { invert: true }),
  table_name: Joi.string().required().regex(disallowedCharsRegexWithSpace, { invert: true }),
  schema: Joi.string().required().regex(disallowedCharsRegexWithSpace, { invert: true }),
  ...
  target_connection_id: Joi.number().required()
})
